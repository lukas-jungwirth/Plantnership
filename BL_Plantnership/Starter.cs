...
namespace BL_Plantnership
{
    ...
    public static class Starter
    {
        ...
        internal static SqlConnection GetConnection()
        {
            ...
            string conString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + String.Join(@"\", dirs) + @"\DB_Plantnership\DB_Plantnership\Platnership.mdf; Integrated Security = True; Connect Timeout = 30";
